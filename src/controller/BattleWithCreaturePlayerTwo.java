...
public class BattleWithCreaturePlayerTwo {
    ...
    public BattleWithCreaturePlayerTwo(PlayerTwo player, Creature creature) {
        this.player = player;
    ...
    private void creatureAttack() {
        if (creature.getDoAttack() != player.getDoProtection()) {
            ...
            if (rnbAttack + creature.getAttack() > player.getProtection()) {
                ...
                player.receiveDamageHealth(creature.getDamage());
            } else {
